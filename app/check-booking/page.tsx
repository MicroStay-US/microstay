...
export default function CheckBookingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col   items-center justify-center py-12 px-4 bg-gradient-to-tl from-orange-300 via-white/40 to-teal-300 dark:bg-gradient-to-b dark:from-black dark:via-slate-900 dark:to-black">
