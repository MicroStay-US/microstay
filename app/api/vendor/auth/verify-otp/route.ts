...
export async function POST(req: NextRequest) {
  ...
  // Sign in as vendor using the provided credentials
  ...
  if (signInErr || !data.session) {
    console.error('Vendor sign-in error:', signInErr?.message);
  ...
  await svc.from('vendor_otp_codes').delete().eq('id', otpRow.id);
