    ...
    <section className="min-h-screen bg-slate-200 dark:bg-slate-950 dark:text-white">
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2">
          {/* Contact Form */}
          <div className="rounded-3xl border border-ms-orange bg-ms-orange-light dark:border-slate-800 dark:bg-slate-900/60 p-8 backdrop-blur-sm">
            <div className="mb-8">
          ...
          <div className="space-y-6">
            <div className="rounded-3xl border bg-ms-orange-light dark:border-slate-800 dark:bg-slate-900/60 p-8">
              ...
              <p className="mt-4 dark:text-slate-400">
                Get in touch through any of the following channels.
              </p>
            ...
            <div className="rounded-3xl border bg-ms-orange-light dark:border-slate-800 dark:bg-black p-8">
              ...
              <button className="mt-6 rounded-xl border border-orange-500 px-6 py-3 font-semibold text-orange-500 transition hover:bg-orange-500 hover:text-white">
                Become a Partner
              </button>
            </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border bg-ms-orange-light dark:border-slate-800 dark:bg-slate-950 p-6">
              ...
              <p className="mt-3 text-sm text-slate-400">
                Choose a property, select your preferred duration, and pay only
